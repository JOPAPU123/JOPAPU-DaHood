-- // Title: Silent Aim Aim Lock | By JOPAPU
-- // Credits: By JOPAPU
...
Controller.States.AimAssist = DaHoodSettings.SilentAim
function Controller.SetAimAssist(state)
    Controller.States.AimAssist = state
